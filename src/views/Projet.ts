...
export default class Projet extends Vue {
    ...
    mounted() {
        ...
        this.compo.push(new DragAndDrop("h1", null, "display-1",[["color", true],["background", false]], "mon super titre" ));
        this.compo.push(new DragAndDrop("div", "section", "container", [["color", true],["background", true]]));
        this.compo.push(new DragAndDrop("button", null, "btn btn-primary", [["color", true],["background", true]], "Button"));
